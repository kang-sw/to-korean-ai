    ...
    mod korean_v1 {
        ...
        impl super::super::PromptProfile for KoreanV1 {
            ...
            fn translation(
                ...
                ret.push((
                    Role::System,
                    format!("'지시사항'에 따라 '출력'에 지정된 내용을 출력한다.").into(),
                ));
                ...
                ret.push((
                    ...
                    format!(
                        concat!(
                            "**지시사항\n\n",
                            "다음 규칙을 바탕으로 {lang} 문장을 한국어로 정확하게 번역하십시오.\n\n",
                            "- 원문의 말투를 바꾸지 않는다. 예를 들어, 반말을 존댓말로 바꾸지 않는다.\n",
                            "- '{lang} 원문'의 모든 문장을 번역하며, 문장을 합치거나 나누지 않는다.\n",
                            "- 번역된 내용을 자연스러운 한국어로 작성한다.\n",
                            // "- {lang} 관용구를 적절한 한국어 표현으로 의역한다.\n",
                            // "- 번역 과정에서 화폐의 단위를 바꾸지 않는다.\n",
                            // "- 제공된 문장들은 모두 이어지는 내용이므로, 맥락을 충분히 고려하여 번역한다.\n",
                            "\n\n",
                            "**{lang} 원문\n\n",
                            "{content}",
                            "\n\n\n",
